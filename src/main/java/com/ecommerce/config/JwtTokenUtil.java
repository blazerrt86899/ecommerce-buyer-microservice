...
import static com.ecommerce.model.Constants.ACCESS_TOKEN_VALIDITY_SECONDS;
import static com.ecommerce.model.Constants.SIGNING_KEY;
...
public class JwtTokenUtil implements Serializable {
    ...
    public String generateToken(Buyer buyer) {
        return doGenerateToken(buyer.getUsername());
    }
